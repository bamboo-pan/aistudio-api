...
- `status=planning` + `prd.md` + curated `implement.jsonl` + `meta.prd_status=draft` (or missing) → return to **1.1 / Step 8**, present the whole-PRD summary, and get a distinct confirm/revise/override choice
